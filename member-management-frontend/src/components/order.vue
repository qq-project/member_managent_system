...
#orderPage .mint-header.is-fixed {
  z-index: 2;
}

#orderPage .member-info, .order-info {
  height: 100%;
  margin-bottom: 55px;
}

#orderPage .mint-tab-container {
  margin-top: 105px;
}

#orderPage .mint-searchbar {
  position: fixed;
  width: 100%;
}

#orderPage .mint-cell-value {
  display: flex;
...
#orderPage .mint-cell-left, #orderPage .mint-cell-wrapper {
